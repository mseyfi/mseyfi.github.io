...
| **Multimodal Large Language Models** | GPT-4V, Claude 3, Gemini, LLaVA, MiniGPT-4 |
| **Text-to-Image Generation** | DALL·E, Imagen, Stable Diffusion, Kosmos-2 |
| **Video QA / Temporal Reasoning** | VideoBERT, MERLOT, GPT-4V, VIOLET |
| **Grounded Understanding** | GLIP, OWL-ViT, Grounding DINO |
| **Document Understanding** | Donut, LayoutLMv3, Pix2Struct |
