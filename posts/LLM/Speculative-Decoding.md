...
We perform one sample from this distribution $p'_i$ to get a single replacement token, $x_{new}$. **Cycle Output:** The new tokens generated in this cycle are `[accepted_tokens] + [x_new]`.
