...
## [![Decoder](https://img.shields.io/badge/Decoder_Only-Transformers_(Llama,_GPT)-blue?style=for-the-badge&logo=github)](../posts/LLM/DecoderOnly)
<div style="background-color: #f0f8ff; color: #555;font-weight: 485; padding: 20px; margin: 20px 0; border-radius: 8px; border: 1px solid #ccc;">
...
## [![Encoder](https://img.shields.io/badge/Encoder_Only_Transformers-BERT:_Bidirectional_Encoder_Representations_from_Transformers-blue?style=for-the-badge&logo=github)](../posts/LLM/BERT)
<div style="background-color: #f0f8ff; color: #555;font-weight: 485; padding: 20px; margin: 20px 0; border-radius: 8px; border: 1px solid #ccc;">
